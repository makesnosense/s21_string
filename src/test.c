...
void test_strcspn() {
    ...
    printf("Тест 1: s21: |%zu|  orig: |%zu|\n", s21_strcspn("hello", "he"), strcspn("hello", "he"));
    printf("Тест 2: s21: |%zu|  orig: |%zu|\n", s21_strcspn("world", "o"), strcspn("world", "o"));
    printf("Тест 3: s21: |%zu|  orig: |%zu|\n", s21_strcspn("12345", "12"), strcspn("12345", "12"));
    printf("Тест 4: s21: |%zu|  orig: |%zu|\n", s21_strcspn("abcde", "bc"), strcspn("abcde", "bc"));
    printf("Тест 5: s21: |%zu|  orig: |%zu|\n", s21_strcspn("abcdefg", "fgh"), strcspn("abcdefg", "fgh"));
    printf("Тест 6: s21: |%zu|  orig: |%zu|\n", s21_strcspn("", ""), strcspn("", ""));
    printf("Тест 7: s21: |%zu|  orig: |%zu|\n", s21_strcspn("a", "b"), strcspn("a", "b"));
    printf("Тест 8: s21: |%zu|  orig: |%zu|\n", s21_strcspn("ab", "b"), strcspn("ab", "b"));
    printf("Тест 9: s21: |%zu|  orig: |%zu|\n", s21_strcspn("abc", "b"), strcspn("abc", "b"));
    printf("Тест 10: s21:|%zu|  orig: |%zu|\n", s21_strcspn("abcd", "d"), strcspn("abcd", "d"));
