...
START_TEST(test_sscanf_i_p5) {
  ...
  s21_res = s21_sscanf("23254 06789 0x123", "%d %i %i %n", &s21_a, &s21_b,
                       &s21_c, &s21_n);
  lib_res = sscanf("23254 06789 0x123", "%d %i %i %n", &lib_a, &lib_b, &lib_c,
                   &lib_n);
...
START_TEST(test_sscanf_i_p6) {
  ...
  s21_res = s21_sscanf("23254 06734 0y123", "%d %i %i %n", &s21_a, &s21_b,
                       &s21_c, &s21_n);
  lib_res = sscanf("23254 06734 0y123", "%d %i %i %n", &lib_a, &lib_b, &lib_c,
                   &lib_n);
...
START_TEST(test_sscanf_i_p7) {
  ...
  s21_res = s21_sscanf("23254 -06754 0x12x3", "%d %i %i %n", &s21_a, &s21_b,
                       &s21_c, &s21_n);
  lib_res = sscanf("23254 -06754 0x12x3", "%d %i %i %n", &lib_a, &lib_b, &lib_c,
                   &lib_n);
...
//       sscanf(input_string, format_string, &lib_res1, &lib_res2, &lib_res3);
//   s21_res_res =
//       s21_sscanf(input_string, format_string, &s21_res1, &s21_res2,
//       &s21_res3);
...
Suite* make_sscanf_suite() {
  ...
  tcase_add_test(tc_problem, test_sscanf_possible_minus_one_p7);
