...
START_TEST(test_sprintf_hex_lower_with_modifiers) {
  ...
  unsigned long ul_value = 4294967295UL;  // max for unsigned long
...
START_TEST(test_sprintf_hex_upper_with_modifiers) {
  ...
  int s21_return = 0;
  unsigned short us_value = 255;
  unsigned long ul_value = 4294967295UL + 5;  // max for unsigned long
...
START_TEST(test_sprintf_octal_with_modifiers) {
  ...
  int lib_return = 0;
  int s21_return = 0;
  unsigned short us_value = 0377;           // 255 in base-10
  unsigned long ul_value = 037777777777UL;  // max for unsigned long base-8
...
START_TEST(test_sprintf_sharp_octal_with_modifiers) {
  ...
  unsigned short us_value = 0377U;          // 255 in base-10
  unsigned long ul_value = 037777777777UL;  // max for unsigned long in base-8
  long int min_long_int = LONG_MIN;
